...
> If you want to ask a question, we assume that you have read the available [Documentation](https://cheshire-cat-ai.github.io/core/) and [FAQs](https://cheshire-cat-ai.github.io/core/faq/).
...
- Open an [Issue](https://github.com/cheshire-cat-ai/core/issues//new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment components/versions (Make sure that you have read the [documentation](https://cheshire-cat-ai.github.io/core/). If you are looking for support, you might want to check [this section](#i-have-a-question)).
...
- Open an [Issue](https://github.com/cheshire-cat-ai/core/issues/new). (Since we can't be sure at this point whether it is a bug or not, we ask you not to talk about a bug yet and not to label the issue.)
...
- Read the [documentation](https://cheshire-cat-ai.github.io/core/) carefully and find out if the functionality is already covered, maybe by an individual configuration.
...
See details on how to help with the docs [here](https://github.com/cheshire-cat-ai/core/tree/docs).
