...
const MessageInput: FC<ChatInputProps> = (props) => {
  const { value, onChange, onSubmit, onUpload, disabled, loading, className, ...rest } = props
  ...
  return (
    <form className={classList} onSubmit={handleSubmit}>
      <textarea
        ...
        {...rest}
      />
      <input type="file" ref={inputRef} accept="text/plain, application/pdf" onChange={onFileUploadChange} />
