 ...
 * application.
 */
import { type APIMessageServiceResponse } from '@services/messages'
...
/**
 * A TypeScript type guard that takes a value of unknown type and returns a boolean indicating whether the value is of type
 * APIMessageServiceResponse
 * @param value
 */
