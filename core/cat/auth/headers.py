...
def ws_auth(resource: AuthResource, permission: AuthPermission) -> None | StrayCat:
    ...
    async def ws_auth(
        ...
        credential = await core_auth_handler.ws_extract_credential(websocket)
        ...
        credential = await custom_auth_handler.ws_extract_credential(websocket)
...
def http_auth(resource: AuthResource, permission: AuthPermission) -> None | StrayCat:
    async def http_auth(request: Request) -> None | StrayCat:
        ...
        credential = await core_auth_handler.http_extract_credential(request)
        ...
        credential = await custom_auth_handler.http_extract_credential(request)
