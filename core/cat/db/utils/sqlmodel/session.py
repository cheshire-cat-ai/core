"""
This class is copied from SQLModel and simplified .execute method of session.
...
from cat.db.utils.sqlmodel.executable import Executable
from cat.db.utils.sqlmodel.select import Select, SelectOfScalar
