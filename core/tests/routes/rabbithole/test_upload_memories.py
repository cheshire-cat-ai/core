...
def test_upload_memory_check_embedder(client):
    ...
    assert f"Embedder mismatch: file embedder {another_embedder} is different from FakeEmbeddings" in str(e.value)
...
def get_fake_memory_export(embedder_name="FakeEmbeddings", dim=128):
    return {
