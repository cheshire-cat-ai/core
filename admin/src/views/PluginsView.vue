...
<template>
	<div class="flex flex-col gap-8 self-center md:w-3/4">
		<div class="col-span-2 flex flex-col items-center justify-center gap-6 rounded-xl bg-base-300 p-8">
		...
		<template v-else>
			<div v-for="item in pluginsState.data" :key="item.id" class="flex items-center gap-4 rounded-xl bg-base-200 p-4">
				<div class="placeholder avatar">
					<div class="h-20 w-20 rounded-xl bg-gradient-to-b from-blue-500 to-primary text-base-100">
